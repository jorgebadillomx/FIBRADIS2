...
- **Motion**: Use animations for effects and micro-interactions. Use Motion library for React when available. Focus on high-impact moments: staggered reveals, scroll-triggering and hover states that surprise.
...
NEVER use generic AI-generated aesthetics like overused font families (Inter, Roboto, Arial), cliched color schemes (purple gradients on white), predictable layouts, or cookie-cutter design.
