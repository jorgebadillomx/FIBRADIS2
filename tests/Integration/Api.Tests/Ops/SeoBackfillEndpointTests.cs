...
public class SeoBackfillEndpointTests
{
    ...
    private static async Task<SeoMetadata> SeedStaticRowAsync(ApiWebFactory factory)
    {
        ...
        var row = new SeoMetadata
        {
            ...
            EntityKey = "/acerca",
            Title = "Sobre FIBRADIS — Metodología y Fuentes de Datos | FIBRADIS",
            MetaDescription = "Conoce la metodología de FIBRADIS: fuentes de datos y cálculo de fundamentales para FIBRAs mexicanas.",
            CanonicalPath = "/acerca",
            OgTitle = "Sobre FIBRADIS — Metodología y Fuentes de Datos | FIBRADIS",
            OgDescription = "Conoce la metodología de FIBRADIS.",
            OgType = "website",
