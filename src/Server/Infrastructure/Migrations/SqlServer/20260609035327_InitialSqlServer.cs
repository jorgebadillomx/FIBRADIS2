        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    request_raw = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    news_model = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    ...
                    min_body_text_length_for_ai = table.Column<int>(type: "int", nullable: false, defaultValue: 500)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ticker = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    yahoo_ticker = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    updated_at = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    updated_by = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
                    terms_enabled = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    terms_text = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    contact_email = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
                    UniverseDegradationThresholdPct = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Pago = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    costo_promedio = table.Column<decimal>(type: "decimal(18,6)", precision: 18, scale: 6, nullable: false),
                    costo_total_compra = table.Column<decimal>(type: "decimal(18,6)", precision: 18, scale: 6, nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { new Guid("132f2dbd-1a77-3ca5-01eb-c65b7a03b14b"), new DateTimeOffset(new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), "MXN", null, "Fibra Upsite", null, "BMV", "[\"Fibra Upsite\",\"Upsite\",\"FIBRAUP\"]", "https://fibra-upsite.com/inversionistas/razones", "Industrial", "Upsite", "https://fibra-upsite.com", "Active", "FIBRAUP18", "FIBRAUP18.MX" },
                    { new Guid("15d3465f-5ff4-a84c-c883-1dd381fd22f0"), new DateTimeOffset(new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), "MXN", null, "CFE Fibra E", "https://cfecapital.com.mx/inversionistas", "BMV/BIVA", "[\"CFE Fibra E\",\"FCFE\",\"FCFE18\"]", "https://cfecapital.com.mx/informacion-financiera", "Infraestructura", "CFE Fibra E", "https://cfecapital.com.mx", "Active", "FCFE18", "FCFE18.MX" },
                    ...
                    { new Guid("2799e174-1233-93ba-87ce-ade15c0c4010"), new DateTimeOffset(new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), "MXN", null, "Fibra Macquarie", "https://fibramacquarie.com.mx/ri", "BMV", "[\"Fibra MQ\",\"Macquarie\",\"FIBRAMQ\"]", "https://www.fibramacquarie.com/es/inversionistas.html", "Industrial", "FibraMQ", "https://fibramacquarie.com.mx", "Active", "FIBRAMQ12", "FIBRAMQ12.MX" },
                    ...
                    { new Guid("38a237f5-9065-f4ec-7b19-c116a9642c6f"), new DateTimeOffset(new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), "MXN", null, "Fibra Inn", null, "BMV", "[\"Fibra Inn\",\"FINN\"]", "https://fibrainn.mx/inversionistas/resultados-trimestrales", "Hotelero", "Fibra Inn", "https://fibrainn.com.mx", "Active", "FINN13", "FINN13.MX" },
                    { new Guid("5d911406-8042-d1db-90b0-6c5aebb882bf"), new DateTimeOffset(new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), "MXN", null, "Fibra Danhos", "https://fibradanhos.com.mx/ri", "BMV", "[\"Danhos\",\"DANHOS\"]", "https://fibradanhos.com.mx/reportes-trimestrales.html", "Comercial", "Danhos", "https://fibradanhos.com.mx", "Active", "DANHOS13", "DANHOS13.MX" },
                    { new Guid("6cbe26c2-2ed0-6df0-6242-1c78d011e9fc"), new DateTimeOffset(new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), "MXN", null, "Fibra Hotel", null, "BMV", "[\"Fibra Hotel\",\"FIHO\"]", "https://www.bmv.com.mx/es/emisoras/informacionfinanciera/FIHO-30057-CGEN_CAPIT", "Hotelero", "Fibra Hotel", "https://fibrahotel.com", "Active", "FIHO12", "FIHO12.MX" },
                    { new Guid("7347fc56-b1d8-1853-7712-ac4dc204564c"), new DateTimeOffset(new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), "MXN", null, "Fibra Uno", "https://fibra.uno/inversionistas", "BMV", "[\"Fibra Uno\",\"FUNO\"]", "https://funo.mx/inversionistas/suplementos-informativos", "Diversificado", "Fibra Uno", "https://fibra.uno", "Active", "FUNO11", "FUNO11.MX" },
                    { new Guid("7882f6d3-304f-5de6-2211-60508c2021c6"), new DateTimeOffset(new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), "MXN", null, "Fibra Monterrey", "https://fibramty.com/inversionistas", "BMV", "[\"Fibra Monterrey\",\"FibraMTY\",\"FMTY\"]", "https://www.fibramty.com/en/inversionistas", "Industrial", "Fibra MTY", "https://fibramty.com", "Active", "FMTY14", "FMTY14.MX" },
                    ...
                    { new Guid("9797ad53-1324-9a81-6102-992b9f07e92c"), new DateTimeOffset(new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), "MXN", null, "Fibra SOMA", null, "BIVA", "[\"Fibra SOMA\",\"SOMA\",\"SOMA21\"]", "https://fibrasoma.group/investors/quarterly-reports-2/", "Comercial", "Fibra SOMA", "https://fibrasoma.group", "Active", "SOMA21", "SOMA21.MX" },
                    { new Guid("ae26cf6f-b4dc-be5a-3355-f4f4a9165499"), new DateTimeOffset(new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), "MXN", null, "Fibra Vesta", "https://fibravesta.com/ri", "BMV", "[\"Fibra Vesta\",\"VESTA\"]", "https://ir.vesta.com.mx/es/financial-results", "Industrial", "Vesta", "https://fibravesta.com", "Active", "VESTA15", "VESTA.MX" },
                    { new Guid("d96dd899-9a7e-3c95-a9ba-bbf62577a241"), new DateTimeOffset(new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), "MXN", null, "Fibra Hotel City Express", null, "BMV", "[\"Hotel City Express\",\"HCITY\",\"HC\"]", "https://www.norte19.com/investors", "Hotelero", "HC", "https://hcity.com.mx", "Active", "HCITY17", "HCITY.MX" }
                });
