...
namespace Infrastructure.Migrations.SqlServer
{
    ...
    [Migration("20260618180316_AddFibraEXIAndAGRO")]
    partial class AddFibraEXIAndAGRO
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Catalog.Fibra", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            Currency = "MXN",
                            Description = "Fibra EXI es un fideicomiso de inversión en energía e infraestructura (Fibra E) especializado en concesiones de autopistas de peaje. Su portafolio comprende más de 400 km de carreteras concesionadas en el centro del país, incluyendo la autopista Salamanca-León en Guanajuato. Cotiza en la BMV bajo el ticker FEXI21.",
                            FullName = "Fibra EXI",
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            Currency = "MXN",
                            Description = "AgroFibra es el primer fideicomiso de inversión en bienes raíces en México especializado en el sector agroalimentario. Su portafolio incluye propiedades agrícolas arrendadas a productores y empresas de la cadena agroalimentaria en diversas regiones del país. Cotiza en BIVA bajo el ticker AGRO22.",
                            FullName = "AgroFibra",
